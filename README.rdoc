...
* Frame recycle: - message_popstr
                 - message_destroy
* check socket types for send / receive in examples
...
* Test cases for Frame, Message etc. with GC.stress = true
* Should the current ZMQ context referenced be indexed by PID ?
* ZmqRaiseError -> ZmqRaiseSysError ?
