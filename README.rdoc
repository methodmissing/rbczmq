...
* Assert sockets registered with ZMQ::Poller instances are in bound or connected states
* Remove noop ZMQ_POLLERR from zloop wrapper - useless for 0MQ sockets
