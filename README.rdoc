...
* Let ZMQ::Frame.new(frame) just return the given frame
* Revisit threading integration on 1.8
* Also handle bind / connect support in socket specific mixins eg. REP socket can't connect
...
* Check for cross thread socket violations on loop registeration as well